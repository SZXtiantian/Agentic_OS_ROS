...
ERROR_CODES = {
    ...
    "HUMAN_PROVIDER_UNCONFIGURED",
    "INTERVENTION_PROVIDER_UNCONFIGURED",
    "ROS_BRIDGE_MODE_UNSUPPORTED",
    "ROS_BRIDGE_UNAVAILABLE",
    "ROS_SERVICE_UNAVAILABLE",
    "ROS_ACTION_UNAVAILABLE",
    "ROS_HTTP_BRIDGE_UNCONFIGURED",
    "ROS_HTTP_BRIDGE_UNAVAILABLE",
    "ROS_WS_BRIDGE_UNCONFIGURED",
    "ROS_WS_BRIDGE_UNAVAILABLE",
    ...
    "HELLO_WORLD_LLM_REQUIRED",
    "HELLO_WORLD_LLM_PLAN_INVALID",
    "COLOR_BLOCK_LLM_PLAN_REQUIRED",
    "COLOR_BLOCK_LLM_PLAN_INVALID",
