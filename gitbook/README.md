...
Agentic OS exposes high-level, permissioned, safe, auditable robot capabilities to Agent Apps. This documentation is organized for GitBook and mirrors the developer-facing layout used by AIOS-style docs: overview first, then SDK namespaces, then reference material.
